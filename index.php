...
<body onload="myfunction()">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">SS</h1>
			</div>
         ...
         <div class="service-are" id="service">
			...
			<section class="work" id="work"><br>
				...
				<div class="container-fluid">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work2.png" title="this is a sky image">
								<img src="img/work21.png" class="img-responsive">
							</a>
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work23.jpg" title="this is a sky image">
								<img src="img/work23.jpg" class="img-responsive">
							</a>
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work6.png" title="this is a sky image">
								<img src="img/work24.png" class="img-responsive">
							</a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/sayan.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Sayan Saha</h4>
									
									<ul class="social-list">
										<li><a href="https://www.facebook.com/profile.php?id=100009044142435&mibextid=ZbWKwL"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/sim.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Simran kumari</h4>
									
									<ul class="social-list">
										<li><a href="https://" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https:///SunilYa35862617" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/ISHA.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Isha Yadav</h4>
							...
							<div class="team-member text-center">
								<img src="img/ari.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Arijit Ray</h5>
